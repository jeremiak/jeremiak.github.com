...
(function(global, factory) {
  ...
  function setup(ref) {
    ...
    stepEl.forEach(function(s, i) {
      return setupStep({ id: id, i: i });
    });
  ...
  function update(ref) {
    ...
    stepOffsetHeight.forEach(function(h, i) {
      return updateStep({ id: id, h: h, i: i, offsetMargin: offsetMargin });
    });
  ...
  function scrollama() {
    ...
    function notifyStepProgress(element, progress) {
      ...
      if (
        ...
        typeof callback.stepProgress === "function"
      ) {
    ...
    function notifyContainerExit() {
      ...
      if (
        callback.containerExit &&
        typeof callback.containerExit === "function"
      ) {
	...
	*/
    ...
    function updateBottomIO() {
      ...
      var options = {
        root: null,
        rootMargin:
          "-" + bboxGraphic.height + "px 0px " + bboxGraphic.height + "px 0px",
        threshold: 0
      };
